...
class Operateur extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(OperateurHasCriteres::className(), ['Operateur_Operateur_id' => 'Operateur_id']);
    }
    ...
    {
        return $this->hasMany(Criteres::className(), ['Critere_id' => 'Criteres_Critere_id'])->viaTable('operateur_has_criteres', ['Operateur_Operateur_id' => 'Operateur_id']);
    }
